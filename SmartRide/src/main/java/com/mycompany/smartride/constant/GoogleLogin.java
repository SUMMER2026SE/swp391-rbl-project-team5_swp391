...
//    public static com.mycompany.smartride.dto.Account getAccountFromEmail(final String accessToken) throws IOException {
//        String jsonInfo = getUserInfo(accessToken);
//        JSONObject jsonObject = new JSONObject(jsonInfo);
...
//        com.mycompany.smartride.dto.Account account = new com.mycompany.smartride.dto.Account();
