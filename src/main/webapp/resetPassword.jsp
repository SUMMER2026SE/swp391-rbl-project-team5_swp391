...
<html lang="en">
    <head>
        ...
        <title>Thay đổi mật khẩu - SmartRide</title>
        ...
        <style>
            ...
            #password-eye:hover, .password-eye:hover {
                color: var(--primary-color);
            }
            .text-error {
                font-size: 13px;
    ...
    <body>
        <div class="login-wrapper">
            ...
            <div class="login-form-side animate__animated animate__fadeInLeft">
                ...
                <h1 class="welcome-title">Thay đổi mật khẩu</h1>
                <p class="welcome-subtitle">Vui lòng nhập mật khẩu mới của bạn bên dưới.</p>
                ...
                <c:if test="${not empty requestScope.errorPass}">
                    <div class="alert-custom animate__animated animate__headShake" role="alert">
                        ...
                        <span>${requestScope.errorPass}</span>
                    </div>
                </c:if>
                <c:if test="${not empty requestScope.successChange}">
                    <div class="alert-info-custom animate__animated animate__fadeIn" role="alert" style="color: #166534 !important; background-color: #f0fdf4 !important; border: 1px solid #bbf7d0 !important;">
                        <i class="ri-checkbox-circle-line" style="font-size: 20px;"></i>
                        <span>${requestScope.successChange}</span>
                    </div>
                </c:if>
                ...
                <form action="updatepassword" method="post" id="signupForm">
                    ...
                    <div class="form-group-custom">
                        <div class="input-wrapper-custom animate__animated animate__fadeInUp" style="animation-delay: 0.1s;">
                            <i class="ri-lock-line input-icon"></i>
                            <input id="newPassword" type="password" name="newPassword" placeholder="Mật khẩu mới" required />
                            <span class="password-eye" onclick="showPassword('newPassword')"><i class="ri-eye-off-line"></i></span>
                        </div>
                    ...
                    <!-- Confirm Password -->
                    <div class="form-group-custom">
                        <div class="input-wrapper-custom animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                            <i class="ri-lock-password-line input-icon"></i>
                            <input id="confirmPassword" type="password" name="confirmPassword" placeholder="Xác nhận mật khẩu mới" required />
                            <span class="password-eye" onclick="showPassword('confirmPassword')"><i class="ri-eye-off-line"></i></span>
                        </div>
                        <span class="text-error" id="confirmpassword-text"></span>
                    </div>

                    <!-- Submit Button -->
                    <button class="btn-login-submit animate__animated animate__fadeInUp" style="animation-delay: 0.3s;" type="submit">
