...
@WebServlet(name = "SearchMotorcycleLoadMoreServlet", urlPatterns = {"/loadSearchName"})
public class SearchMotorcycleLoadMoreServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Motorcycle> listM = MotorcycleDAO.getInstance().searchNext3MotorcyclesByName(key, iAmount);
