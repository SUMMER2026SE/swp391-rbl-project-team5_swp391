    ...
    <body>
        <div class="login-wrapper">
            ...
            <div class="login-form-side animate__animated animate__fadeInLeft">
                ...
                <!-- Google -->
                <a class="btn-google-login" href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/SmartRideSystem/login-google&response_type=code&client_id=427529527508-oc10hcpl7tv41q12bhjkk1lpvnupe80k.apps.googleusercontent.com&approval_prompt=force">
